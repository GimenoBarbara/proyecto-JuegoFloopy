...
juego de desplazamiento horizontal con obstaculos hecho en c para consola,
el juego se compila y ejecuta desde el main.c , 
con interfaz grafica mediante Raylib.
...
*COMO JUGAR*
1- Para Jugar 
Presionar la tecla de espacio para subir.
